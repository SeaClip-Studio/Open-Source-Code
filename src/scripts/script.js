...
function project1() {
	window.open(
		"https://github.com/SeaClip-Studio/Open-Source-Code",
		"target=_blank"
	);
}
function project2() {
	window.open(
		"https://github.com/SeaClip-Studio/greate-games-studio",
		"target=_blank"
	);
}
function project3() {
	window.open("https://github.com/SeaClip-Studio/SawixWeb", "target=_blank");
}